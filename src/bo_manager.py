...
class BOmanager(object):
    ...
    def __init__(self, f, dataset, x_columns, target_column, constraint_column, constraints_bounds, seed, output_path, init_points=None, n_iter=1, log_name='results', decay_bounds=None):
        """
        ...
        bo = BO(objective_function = dummy_objective, domain_bounds = bounds, gp = gp, af = af, constraint_functions = None, initial_points = 5, random_state = seed, logger = logger, dataset = ds)
